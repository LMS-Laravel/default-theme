    ...
    <div class="col-md-6 col-lg-7">
        ...
        <div class="block">
            ...
            <div class="block-title">
                @trans('user::ui.profile.message-box-status')
            </div>
            <!-- END Updates Title -->

            <!-- Update Status Form -->
            {!! Form::open(['route' => 'dashboard.learning', 'id'=>'form-login', 'method' => 'POST', 'class' => 'block-content-full block-content-mini-padding'])  !!}
            <textarea id="status" name="status" rows="2" class="form-control push-bit" placeholder="@trans('user::ui.profile.question-box-question')"></textarea>
            <div class="clearfix">
                <button type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-pencil"></i> @trans('user::ui.profile.btn-publish')</button>
            </div>
            {!! Form::close()  !!}
                            ...
                            <div class="media-body">
                                ...
                                <ul class="media-list push">
                                    <li class="media">
                                        ...
                                        @endforeach
                                        <div class="media-body">
                                            <form action="{{ route('new_comment_status') }}" method="post">

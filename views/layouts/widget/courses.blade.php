...
<div class="block">
    ...
    <table class="table table-striped table-vcenter">
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{ route('learning.course.show', $course->slug) }}">{{ $course->name }}</a><br>
                </td>
                <td class="text-center" style="width: 70px;">
                    <div class="btn-group btn-group-xs">
                        ...
                        <a href="{{ route('learning.course.show', $course->slug) }}" class="btn btn-default"><i class="fa fa-university"></i></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
